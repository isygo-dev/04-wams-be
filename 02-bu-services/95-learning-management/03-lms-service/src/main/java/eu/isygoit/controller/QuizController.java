...
import eu.isygoit.exception.handler.LmsExceptionHandler;
...
@Validated
@RestController
@InjectMapperAndService(handler = LmsExceptionHandler.class, mapper = QuizMapper.class, minMapper = QuizMapper.class, service = QuizService.class)
