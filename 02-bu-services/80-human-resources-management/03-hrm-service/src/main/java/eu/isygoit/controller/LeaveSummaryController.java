...
@Validated
@RestController
@InjectMapperAndService(handler = HrmExceptionHandler.class, mapper = LeaveSummaryMapper.class, minMapper = LeaveSummaryMapper.class, service = LeaveSummaryService.class)
