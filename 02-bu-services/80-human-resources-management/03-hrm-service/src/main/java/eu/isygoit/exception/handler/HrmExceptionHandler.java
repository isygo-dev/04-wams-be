...
@Slf4j
@Component
public class HrmExceptionHandler extends ControllerExceptionHandler {
    ...
    /**
     * Instantiates a new Hrm exception handler.
     *
     * @param appProperties the app properties
     */
    public HrmExceptionHandler(AppProperties appProperties) {
