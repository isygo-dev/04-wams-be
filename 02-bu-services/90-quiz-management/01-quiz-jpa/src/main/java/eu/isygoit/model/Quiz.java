...
@Table(name = SchemaTableConstantName.T_QUIZ, uniqueConstraints = {
        ...
        @UniqueConstraint(name = SchemaUcConstantName.UC_QUIZ_TENANT_NAME,
...
public class Quiz extends AuditableCancelableEntity<Long> implements ITenantAssignable, ICodeAssignable {
