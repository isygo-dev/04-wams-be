...
/**
 * The type Integration exception handler.
 */
@Slf4j
@Component
public class IntegrationExceptionHandler extends ControllerExceptionHandler {
    ...
    /**
     * Instantiates a new Integration exception handler.
     *
     * @param appProperties the app properties
     */
    public IntegrationExceptionHandler(AppProperties appProperties) {
