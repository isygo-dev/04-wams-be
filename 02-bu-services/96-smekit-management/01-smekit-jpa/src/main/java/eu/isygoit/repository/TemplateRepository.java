...
@Repository
public interface TemplateRepository extends JpaPagingAndSortingTenantAssignableRepository<Template, Long>, JpaPagingAndSortingCodeAssignableRepository<Template, Long> {
