...
/**
 * The type SmeKit exception handler.
 */
@Slf4j
@Component
public class SmeKitExceptionHandler extends ControllerExceptionHandler {
    ...
    public SmeKitExceptionHandler(AppProperties appProperties) {
