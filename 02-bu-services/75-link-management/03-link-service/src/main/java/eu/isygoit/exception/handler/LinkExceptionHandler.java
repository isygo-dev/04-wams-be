...
@Slf4j
@Component
public class LinkExceptionHandler extends ControllerExceptionHandler {
    ...
    /**
     * Instantiates a new Link exception handler.
     *
     * @param appProperties the app properties
     */
    public LinkExceptionHandler(AppProperties appProperties) {
